            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-success" onclick="myFunction1()" id="myBtn1">Read more</button>
                                </div>
                            </div>
                            <!-- Blog post-->
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-success" onclick="myFunction2()" id="myBtn2">Read more</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="#!"><img class="card-img-top" src="images/img9.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <div class="small text-muted">January 1, 2021</div>
                                    <h2 class="card-title h4">Post Title</h2>
                                    ...
                                    <button class="btn btn-success" onclick="myFunction3()" id="myBtn3">Read more</button>
                                </div>
                            </div>
                            <!-- Blog post-->
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-success" onclick="myFunction4()" id="myBtn4">Read more</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <nav aria-label="Pagination">
                        ...
                        <ul class="pagination justify-content-center my-4">
                            <li class="page-item disabled"><a class="page-link text-secondary" href="#" tabindex="-1" aria-disabled="true">Newer</a></li>
                            <li class="page-item active" aria-current="page"><a class="page-link bg-dark" href="#!">1</a></li>
                            <li class="page-item"><a class="page-link text-secondary" href="#!">2</a></li>
                            <li class="page-item"><a class="page-link text-secondary" href="#!">3</a></li>
                            <li class="page-item disabled"><a class="page-link text-secondary" href="#!">...</a></li>
                            <li class="page-item"><a class="page-link text-secondary" href="#!">15</a></li>
                            <li class="page-item"><a class="page-link text-secondary" href="#!">Older</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- Side widgets-->
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">Anything</div>
                    </div>
                </div>
            </div>
